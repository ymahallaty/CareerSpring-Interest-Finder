    ...
    return (
        ...
        <form className="mx-auto [overflow-anchor:none]">
            <fieldset>
                ...
                <section className="flex leading-10 gap-8 justify-center items-center text-[16px] w-[108%] pt-2.5 pb-1.5 [overflow-anchor:none]  ">
                    {
                      !pickYourAnswerArray? null: pickYourAnswerArray.map((ele, index) => {
                        return (
                            <div className=" [overflow-anchor:none]" key={index + 1}>
                                <label className="answer-option-labels [overflow-anchor:none]">
                                    <input
