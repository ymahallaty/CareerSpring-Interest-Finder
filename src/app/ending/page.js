export default function page() {
    return (
      <div className="relative bg-white text-black px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10">
        <h1 className="space-y-6 py-5 text-4xl leading-7 text-gray-600 leading-relaxed">Great Job! You Answered All Questions!</h1>
        ...
        <div className="text-center mb-6">
          <button className="bg-career-blue py-5 text-base leading-7 text-white p-4">Go back to the first page</button>
        </div>
        ...
        <div className="flex justify-between">
          <button className="bg-career-blue py-5 text-base leading-7 text-white p-4">Back</button>
          <button className="bg-career-blue py-5 text-base leading-7 text-white p-4">Get Interest Results</button>
        </div>
      </div>
    );
  }
