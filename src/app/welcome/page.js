...
function Page() {
  return (
    <div className="relative bg-white m-5 text-black px-6 pt-5 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10">
      <h1 className="space-y-6 py-5 text-4xl leading-7 text-gray-600">
        Career Interest Finder
      </h1>
      ...
      >
        <button className="orangeBrand flex text-gray-600 hover:bg-yellow-600">
          Start Career Interest Finder
        </button>
      </Link>

      <p className="space-y-6 py-5 text-base leading-7 text-gray-600">
        Taken the Interest Profiler before?
      </p>
      ...
      <a
        href="/user-agreement"
        class="space-y-6 py-5 text-base hover:underline"
      >
        User Agreement Proper Use
      </a>
    </div>
  );
}
