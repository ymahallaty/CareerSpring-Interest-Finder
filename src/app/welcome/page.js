...
function page() {
  return (
    <div className="relative bg-white text-black px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10">
      ...
      <button className="bg-yellow-500 space-y-6 py-5 text-base leading-7 text-gray-600">Start Career Interest Finder</button>
      <p className="space-y-6 py-5 text-base leading-7 text-gray-600">Taken the Interest Profiler before?</p>
      <button className="bg-yellow-500 space-y-6 py-5 text-base leading-7 text-gray-600">Enter Scores</button>
      <br/>
