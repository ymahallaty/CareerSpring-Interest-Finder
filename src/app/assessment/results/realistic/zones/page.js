...
export default function Realistic() {
    ...
    const url = `https://services.onetcenter.org/ws/mnm/interestprofiler/careers?area=Realistic&job_zone=${zone}`;
    ...
    return (
        <div className="pageDiv">
            ...
            <h1 className="titleH1">All Realistic Careers Job Zone {zone}</h1>
            </div>
            ...
            <h1 className="text-xl mt-10">Realistic: {riasec[1]} </h1>
            <h1 className="text-xl mt-10"> Realistic careers that fit your preparation level:</h1>
            <div>
            <ul>
                {careers.map(career => (
                <li key={career.code}>
