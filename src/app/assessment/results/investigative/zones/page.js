...
export default function investigative() {
    ...
    const url = `https://services.onetcenter.org/ws/mnm/interestprofiler/careers?area=Investigative&job_zone=${zone}`;
    ...
    return (
        <div className="pageDiv">
            ...
            <h1 className="titleH1">All Investigative Careers Job Zone {zone}</h1>
            </div>
            ...
            <h1 className="text-xl mt-10">Investigative: {riasec[1]} </h1>
