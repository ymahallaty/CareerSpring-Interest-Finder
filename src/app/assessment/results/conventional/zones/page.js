...
export default function Conventional() {
    ...
    const url = `https://services.onetcenter.org/ws/mnm/interestprofiler/careers?area=Conventional&job_zone=${zone}`;
    ...
    return (
        <div className="pageDiv">
            ...
            <h1 className="titleH1">All Conventional Careers Job Zone {zone}</h1>
            </div>
