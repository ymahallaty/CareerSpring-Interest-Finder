...
export default function Social() {
    ...
    const url = `https://services.onetcenter.org/ws/mnm/interestprofiler/careers?area=Social&job_zone=${zone}`;
    ...
    return (
        <div className="pageDiv">
            ...
            <h1 className="titleH1">All Social Careers Job Zone {zone}</h1>
            </div>
            ...
            <h1 className="text-xl mt-10">Social: {riasec[1]} </h1>
            <h1 className="text-xl mt-10"> Social careers that fit your preparation level:</h1>
            <div>
            <ul>
                {careers.map(career => (
                <li key={career.code}>
