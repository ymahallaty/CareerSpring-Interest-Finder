...
function JobZones (){
    ...
    return(
        <div className="block-group block-padding content-center">
            ...
            <ul>
                <li className="underline interFont"><Link href={`/assessment/job-zones/job-zone-3?riasec=${riasec}`}>Job Zone 3: Medium Job Preparation</Link></li>
                <li className="underline interFont"><Link href={`/assessment/job-zones/job-zone-4?riasec=${riasec}`}>Job Zone 4: High Job Preparation</Link></li>
                <li className="underline interFont"><Link href={`/assessment/job-zones/job-zone-5?riasec=${riasec}`}>Job Zone 5: Extensive Job Preparation</Link></li>
            </ul>
            <div className="button-container">
               ...
               <Link href={`/careers?riasec=${riasec}`}><button className="blueButton">Find Careers for You</button></Link>
            </div>
        </div>
    )
}
